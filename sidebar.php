...
<div class="side-header">
    <img  style="margin-left:20px"src="./assets/images/logo.png" width="80" height="80" alt="Swiss Collection"> 
    <h5 style="margin-top:8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Admin</h5>
</div>
...
<div id="main">
    <button class="openbtn" onclick="openNav()"><i class="fa fa-home" style="font-size:20px"></i></button>
</div>
